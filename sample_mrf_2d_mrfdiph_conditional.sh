...
export OPENAI_LOGDIR="./models/cut_${cut}_imgsize_${image_size}_conditional/mrfdiph_samples_lambda${lambda}"
...
SAMPLING_FLAGS="--timestep_respacing ${timesteps} --use_condition True --test_vols 0 --test_slices 5,10,15"
...
MODEL_PATH="./models/cut_${cut}_imgsize_${image_size}_conditional/ema_0.9999_${checkpoint}.pt"
